...
/*                                drone.Forward(tello.ValidatePitch(rightStick.y, offset))*/
                                drone.Up(tello.ValidatePitch(rightStick.y, offset))
                        case rightStick.y > 10:
/*                                drone.Backward(tello.ValidatePitch(rightStick.y, offset))*/
                                drone.Down(tello.ValidatePitch(rightStick.y, offset))
                        default:
/*                                drone.Forward(0)*/
                                drone.Up(0)
                        }
...
/*                                drone.Up(tello.ValidatePitch(leftStick.y, offset))*/
                                drone.Forward(tello.ValidatePitch(leftStick.y, offset))
                        case leftStick.y > 10:
/*                                drone.Down(tello.ValidatePitch(leftStick.y, offset))*/
                                drone.Backward(tello.ValidatePitch(leftStick.y, offset))
                        default:
/*                                drone.Up(0)*/
                                drone.Forward(0)
                        }
